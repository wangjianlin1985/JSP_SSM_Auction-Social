		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#productBiddingListPanel" aria-controls="productBiddingListPanel" role="tab" data-toggle="tab">我的竞拍订单</a></li>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>订单编号</td><td>竞拍图书</td><td>竞拍时间</td><td>竞拍出价</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="productBiddingQueryForm" id="productBiddingQueryForm" action="<%=basePath %>ProductBidding/userFrontlist" class="mar_t15">
            <div class="form-group">
            	<label for="itemObj_itemId">竞拍图书：</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="productBidding_itemObj_itemId_edit" class="col-md-3 text-right">竞拍图书:</label>
		  	 <div class="col-md-9">
