		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#userFollowListPanel" aria-controls="userFollowListPanel" role="tab" data-toggle="tab">我的关注列表</a></li>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>记录id</td><td>被关注人</td><<td>关注时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											...
 											<td>
 												...
 												<a href="#" onclick="userFollowDelete('<%=userFollow.getFollowId() %>');"><i class="fa fa-trash-o fa-fw"></i>取消关注</a>
 											</td> 
 										</tr>
 										<%}%>
				    				</table>
