...
<%
    ...
    String pTitle = (String)request.getAttribute("pTitle"); //图书标题查询关键字
...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Item/frontlist">图书信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>Item/item_frontAdd.jsp" style="display:none;">添加图书</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
				...
				for(int i=0;i<itemList.size();i++) {
            		...
            		Item item = itemList.get(i); //获取到图书对象
            		String clearLeft = "";
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Item/<%=item.getItemId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=item.getItemPhoto()%>" /></a>
			     <div class="showFields">
			     	<div class="field">
	            		图书分类:<%=item.getItemClassObj().getClassName() %>
			     	</div>
			     	<div class="field">
	            		图书标题:<%=item.getPTitle() %>
			     	</div>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="itemQueryForm" id="itemQueryForm" action="<%=basePath %>Item/frontlist" class="mar_t15">
            <div class="form-group" style="display:none;">
            	<label for="itemClassObj_classId">图书分类：</label>
			...
			<div class="form-group">
				<label for="pTitle">图书标题:</label>
				<input type="text" id="pTitle" name="pTitle" value="<%=pTitle %>" class="form-control" placeholder="请输入图书标题">
			</div>
            <div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="item_itemId_edit" class="col-md-3 text-right">图书id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="item_itemId_edit" name="item.itemId" class="form-control" placeholder="请输入图书id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="item_itemClassObj_classId_edit" class="col-md-3 text-right">图书分类:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="item_pTitle_edit" class="col-md-3 text-right">图书标题:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="item_pTitle_edit" name="item.pTitle" class="form-control" placeholder="请输入图书标题">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="item_itemPhoto_edit" class="col-md-3 text-right">图书图片:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="item_itemDesc_edit" class="col-md-3 text-right">图书描述:</label>
		  	 <div class="col-md-9">
			    <textarea id="item_itemDesc_edit" name="item.itemDesc" rows="8" class="form-control" placeholder="请输入图书描述"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
